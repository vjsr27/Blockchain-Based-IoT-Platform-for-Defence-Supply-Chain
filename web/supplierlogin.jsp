...
<body class="bg-black">
    ...
    if (msg!=null)
    {
        if (msg.equals("FAILED"))
        {
            %>
            <script>
                alert("supplier login failed!");
                </script>
            <%
        }
        else
        if (msg.equals("DEACTIVE"))
        {
            %>
            <script>
                alert("Your Account is deactivated. Contact MBDA!");
                </script>
            <%
        }   
    ...
    <div class="container pt-5">
        <div class="d-flex flex-column text-center mb-5">
            ...
            <h1 class="m-0">SUPPLIER LOGIN FORM</h1>
            
            
            <form name="supplierlogin" method="post" action="supplierlogin">
