        ...
        <nav class="navbar navbar-expand-lg bg-none navbar-dark py-0">
            ...
            <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                <div class="navbar-nav m-auto py-4">
                    ...
                    <a href="mbdamenu.jsp" class="nav-item nav-link active">Partner Orders</a>
                    <a href="viewpartners.jsp" class="nav-item nav-link active">Partners</a>
                    <a href="viewsuppliers.jsp" class="nav-item nav-link active">Suppliers</a>
  ...
  <%
    ...
    if (msg!=null)
    {
        if (msg.equals("SUCCESS"))
        {
            %>
            <script>
                 alert("Partner Status successfully updated!");
                </script>
            <%
        }
    ...
    try
    {
        ...
        PreparedStatement pst=con.prepareStatement("select * from partner");
        ResultSet rs=pst.executeQuery();
                ...
                while (rs.next())
                    {
                        String mstatus[]={"ACTIVE","DEACTIVE"};
                        int id=rs.getInt(1);
                    %>
                    <form name="update" method=post  action="updatepartnerstatus">
                    <tr>
