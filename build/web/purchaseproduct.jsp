        ...
        <nav class="navbar navbar-expand-lg bg-none navbar-dark py-0">
            ...
            <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                <div class="navbar-nav m-auto py-4">
                    ...
                    <a href="partnercart.jsp" class="nav-item nav-link active">Cart</a>
  ...
  <%
    ...
    if (msg!=null)
    {
        ...
        if (msg.equals("SUCCESS"))
        {
            %>
            <script>
                alert("Your product is waiting for approval from MBDA!");
                </script>
            <%
        }    
    ...
    try
    {
        ...
        int price=0;
        %>
        <form name="purchase" method=get action="purchaseproduct.jsp">
        ...
        if (rs.next())
        {
            ...
            <td><input type="text" name="quantity" value="<%if (request.getParameter("quantity")!=null) out.print(request.getParameter("quantity"));%>" style="width:50px" required/></td>
        ...
        if (request.getParameter("payment")!=null)
        {
            ...
            <form name="finalpayment" method="post" action="partnerpayment">
            <input type="hidden" name="supplier" value="<%=supplier%>" />
            <input type="hidden" name="pname" value="<%=pname%>" />
            ...
            <table align="center" width="600">
                <tr>
                    <td>Total Amount:</td>
                    <td><input type="text" name="total" value="<%out.print(Integer.parseInt(quantity)*price);%>" readonly/></td>
                ...
                <tr>
                    <td>Card No./UPI ID</td>
                    <td><input type="text" name="cno" required/></td>
                    
                </tr>
                <tr>
                    <td></td>
                    <td><input type="submit" name="payment2" value="Final Payment" /></td>
                </tr>
            </table>
            </form>
            <%
